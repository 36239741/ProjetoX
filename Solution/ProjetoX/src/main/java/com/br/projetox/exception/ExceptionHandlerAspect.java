...
public class ExceptionHandlerAspect
{
	...
	@AfterThrowing(pointcut = "within(@org.springframework.stereotype.Service *)", throwing = "exception")
	public void handleException( JoinPoint joinPoint, ImportPlanilhaException exception )
	{
		throw new ImportPlanilhaException(exception.getMessage());
	}
	...
	@AfterThrowing(pointcut = "within(@org.springframework.stereotype.Service *)", throwing = "exception")
	public void handleException( JoinPoint joinPoint, MapPlanoContratadoException exception )
	{
		throw new MapPlanoContratadoException(exception.getMessage());
	}
