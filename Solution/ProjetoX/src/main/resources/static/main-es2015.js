...
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm2015/core.js");
/* harmony import */ var _covalent_dynamic_forms__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @covalent/dynamic-forms */ "./node_modules/@covalent/dynamic-forms/fesm2015/covalent-dynamic-forms.js");
...
let LoginComponent = class LoginComponent {
    constructor(autenticacaoLogin, route) {
    ...
    login() {
        ...
        const senha = this.form.form.get('senha').value;
        if (this.form.valid) {
...
const routes = [
    ...
    { path: 'home', loadChildren: () => __webpack_require__.e(/*! import() | Modulos-Layout-layout-module */ "default~Modulos-Layout-layout-module~app-Modulos-contratos-contratos-module~app-Modulos-relatorios-r~4bb3a372").then(__webpack_require__.bind(null, /*! ./Modulos/Layout/layout.module */ "./src/app/Modulos/Layout/layout.module.ts")).then(m => m.LayoutModule) },
    { path: 'contratos', loadChildren: () => Promise.all(/*! import() | app-Modulos-contratos-contratos-module */[__webpack_require__.e("default~Modulos-Layout-layout-module~app-Modulos-contratos-contratos-module~app-Modulos-relatorios-r~4bb3a372"), __webpack_require__.e("common"), __webpack_require__.e("app-Modulos-contratos-contratos-module")]).then(__webpack_require__.bind(null, /*! ../app/Modulos/contratos/contratos.module */ "./src/app/Modulos/contratos/contratos.module.ts")).then(m => m.ContratosModule) },
    { path: 'relatorios', loadChildren: () => Promise.all(/*! import() | app-Modulos-relatorios-relatorios-module */[__webpack_require__.e("default~Modulos-Layout-layout-module~app-Modulos-contratos-contratos-module~app-Modulos-relatorios-r~4bb3a372"), __webpack_require__.e("common"), __webpack_require__.e("app-Modulos-relatorios-relatorios-module")]).then(__webpack_require__.bind(null, /*! ../app/Modulos/relatorios/relatorios.module */ "./src/app/Modulos/relatorios/relatorios.module.ts")).then(m => m.RelatoriosModule) }
];
...
/* harmony import */ var _covalent_core_loading__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! @covalent/core/loading */ "./node_modules/@covalent/core/fesm2015/covalent-core-loading.js");
...
let AppComponent = class AppComponent {
    ...
    ngOnInit() {
        this.router.events
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["filter"])(event => event instanceof _angular_router__WEBPACK_IMPORTED_MODULE_1__["NavigationStart"] ||
            ...
            event instanceof _angular_router__WEBPACK_IMPORTED_MODULE_1__["NavigationError"])).subscribe(event => {
...
/* harmony import */ var _covalent_core_loading__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! @covalent/core/loading */ "./node_modules/@covalent/core/fesm2015/covalent-core-loading.js");
...
let BasicInterceptorService = class BasicInterceptorService {
    constructor() { }
    intercept(req, next) {
...
/* harmony import */ var _covalent_dynamic_forms__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! @covalent/dynamic-forms */ "./node_modules/@covalent/dynamic-forms/fesm2015/covalent-dynamic-forms.js");
...
let ContratoService = class ContratoService {
    ...
    ;
    findAllContratos(page, size, sort, atributo) {
        return this.httpClient.get(API_URL + '/contratos?page=' + page + "&size=" + size + "&sort=" + sort + "&atributo=" + atributo).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])((data) => data), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["catchError"])(this.handleError));
    }
    findByContrato(numero) {
        return this.httpClient.get(API_URL + '/contratos/' + numero).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])((data) => data), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["catchError"])(this.handleError));
    }
    findByFilters(nome, numero, page, size, statusContrato, sort, atributo) {
        return this.httpClient.get(API_URL + '/contratos/filter?nomePaciente=' + nome +
            '&numero=' + numero + '&ativo=' + statusContrato + '&page=' + page + '&size=' + size + "&sort=" + sort + "&atributo=" + atributo).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])((data) => data), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["catchError"])(this.handleError));
    }
    findByBiometria() {
        return this.httpClient.get(API_URL + '/contratos/find-by-biometria');
    }
    gerarDesconto(numeroContrato, valorDesconto) {
        return this.httpClient.post(API_URL + '/contratos/desconto?numeroContrato=' + numeroContrato, valorDesconto);
    }
    saveBiometria(numeroContrato) {
    ...
    importContratos(xlsx) {
        return this.httpClient.post(API_URL + '/contratos', xlsx);
    }
    getRelatorios(page, size, ano, mes) {
        return this.httpClient.get(API_URL + '/contratos/relatorios?page=' + page + '&size=' + size + '&ano=' + ano + '&mes=' + mes);
    }
    exportPlanilhaRegistros(ano, mes) {
        const httpOptions = {
            'responseType': 'arraybuffer'
        };
        return this.httpClient.get(API_URL + '/contratos/export-relatorio?ano=' + ano + '&mes=' + mes, httpOptions);
    }
};
...
let LoginService = class LoginService {
    ...
    autenticacaoLogin(email, senha) {
        ...
        const headers = new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpHeaders"]({ Authorization: 'Basic ' + basicEncoder });
        return this.http.get(API_URL + '/login', { headers }).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])(userData => {
...
let ToastService = class ToastService {
     ...
     * @param duration
     */
    toastWarnning(message, duration = 5000) {
        let config = new _angular_material__WEBPACK_IMPORTED_MODULE_2__["MatSnackBarConfig"]();
        config.duration = duration;
...
module.exports = ".display-flex {\n  display: -webkit-box;\n  display: flex;\n  -webkit-box-pack: center;\n          justify-content: center;\n  -webkit-box-align: center;\n          align-items: center;\n}\n\n\n/*# sourceMappingURL=data:application/json;base64, */"
...
let ClockBiometriaComponent = class ClockBiometriaComponent {
    constructor(contratoService, tostService, snackBar, message) {
    ...
    cancelCaptureFingerPrint() {
        this.contratoService.cancelCapture().subscribe(() => error => {
            this.snackBar.dismiss();
            this.tostService.toastWarnning(error.error.message);
        });
    }
};
ClockBiometriaComponent.ctorParameters = () => [
    ...
    { type: String, decorators: [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_3__["Inject"], args: [_angular_material__WEBPACK_IMPORTED_MODULE_4__["MAT_SNACK_BAR_DATA"],] }] }
];
ClockBiometriaComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    ...
    tslib__WEBPACK_IMPORTED_MODULE_0__["__param"](3, Object(_angular_core__WEBPACK_IMPORTED_MODULE_3__["Inject"])(_angular_material__WEBPACK_IMPORTED_MODULE_4__["MAT_SNACK_BAR_DATA"]))
...
let ClockBiometriaModule = class ClockBiometriaModule {
};
