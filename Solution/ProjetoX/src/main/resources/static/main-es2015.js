...
const routes = [
    ...
    { path: 'home', loadChildren: () => __webpack_require__.e(/*! import() | Modulos-Layout-layout-module */ "default~Modulos-Layout-layout-module~app-Modulos-contratos-contratos-module").then(__webpack_require__.bind(null, /*! ./Modulos/Layout/layout.module */ "./src/app/Modulos/Layout/layout.module.ts")).then(m => m.LayoutModule) },
    { path: 'contratos', loadChildren: () => Promise.all(/*! import() | app-Modulos-contratos-contratos-module */[__webpack_require__.e("default~Modulos-Layout-layout-module~app-Modulos-contratos-contratos-module"), __webpack_require__.e("app-Modulos-contratos-contratos-module")]).then(__webpack_require__.bind(null, /*! ../app/Modulos/contratos/contratos.module */ "./src/app/Modulos/contratos/contratos.module.ts")).then(m => m.ContratosModule) },
];
...
let ClockBiometriaComponent = class ClockBiometriaComponent {
    constructor(contratoService, tostService, snackBar) {
    ...
    timer() {
        const number = Object(rxjs__WEBPACK_IMPORTED_MODULE_3__["interval"])(1000);
        const takeForNumbers = number.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_6__["take"])(this.tempoDeCapturaBiometria));
