...
let RelatorioRoutingModule = class RelatorioRoutingModule {
};
...
let RelatoriosComponent = class RelatoriosComponent {
    ...
    decimalConverter(valor) {
        return new Intl.NumberFormat("pt-BR", {
            style: "currency",
            currency: "BRL"
        }).format(valor);
    }
    chosenYearHandler(ano) {
        this.ano = 0;
        this.ano = ano;
        console.log(this.ano, this.mes);
    }
    chosenMonthHandler(mes) {
        this.mes = 0;
        this.mes = mes + 1;
        console.log(this.ano, this.mes);
        this.startTable();
    ...
    exportRelatorios() {
        this.contratoService.exportPlanilhaRegistros(this.ano, this.mes).subscribe(planilhaRelatorio => {
            ...
            Object(file_saver__WEBPACK_IMPORTED_MODULE_3__["saveAs"])(fileURL, 'Relatorios' + '_' + this.mes + '-' + this.ano + '.xlsx');
        }, error => {
...
RelatoriosComponent.ctorParameters = () => [
...
/* harmony import */ var _angular_material_moment_adapter__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! @angular/material-moment-adapter */ "./node_modules/@angular/material-moment-adapter/esm2015/material-moment-adapter.js");
...
let YearMonthPickerComponent = class YearMonthPickerComponent {
    constructor() {
...
let TableMaterialComponent = class TableMaterialComponent {
    constructor() {
...
let TableMaterialModule = class TableMaterialModule {
};
...
//# sourceMappingURL=app-Modulos-relatorios-relatorios-module-es2015.js.map