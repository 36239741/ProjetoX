...
var DetatalharContratosComponent = /** @class */ (function () {
    function DetatalharContratosComponent(activeRoute, _dialogService, _viewContainerRef, toastService, behaviorInformacoesContrato, behaviorPlanoContratado, planoContratadoService, contratoService, snackBar) {
...
var RegistrosComponent = /** @class */ (function () {
    ...
    RegistrosComponent.prototype.confirmTrocaDeProfissional = function (tableRow) {
        ...
        this._dialogService.openConfirm({
            ...
            if (accept) {
                _this.registroService.ausenciaProfissional(tableRow.id).subscribe(function (registro) {
...
var VisualizarContratosComponent = /** @class */ (function () {
    ...
    VisualizarContratosComponent.prototype.findServiceAndPlanoContratado = function () {
        var _this = this;
        this.configParametrosService.findCofigParametros('1').subscribe(function (config) {
   ...
   @void*/
    ...
    VisualizarContratosComponent.prototype.sort = function (sortEvent) {
        ...
        this.contratoService.findAllContratos(this.page = 0, this.pageSize, this.sortOrder, this.sortBy).subscribe(function (data) {
    ...
    VisualizarContratosComponent.prototype.refreshTableContratoAfterImport = function () {
        var _this = this;
        this.subscription = this.behaviorRefreshTableContrato.getBehaviorView().subscribe(function (data) {
            if (data === true) {
                _this.contratoService.findAllContratos(0, 10, 'ASC', 'id').subscribe(function (data) {
                    _this.total = data.totalElements;
                    _this.page = data.totalElements;
                    _this.contratos = data['content'];
                });
                _this.planoContratadoService.findTotalActiveContracts().subscribe(function (data) {
