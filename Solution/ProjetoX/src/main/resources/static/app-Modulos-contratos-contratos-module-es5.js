...
var DetatalharContratosComponent = /** @class */ (function () {
    function DetatalharContratosComponent(activeRoute, dialogService, _viewContainerRef, toastService, behaviorInformacoesContrato, behaviorPlanoContratado, planoContratadoService, contratoService, snackBarService, snackBar) {
  ...
  @return void*/
    DetatalharContratosComponent.prototype.findContrato = function () {
        ...
        this.contrato.planoContratado.forEach(function (plano) {
            _this.saldoTotal += plano.saldoMensal;
        });
        this.data.push(this.contrato.planoContratado);
        this.calcularValorPlanos();
    };
    DetatalharContratosComponent.prototype.openSnackBarClockBiometria = function () {
    ...
    DetatalharContratosComponent.prototype.saveBiometria = function () {
        var _this = this;
        this.contratoService.saveBiometria(this.contrato.numero).subscribe(function () {
            _this.snackBar.dismiss();
            _this.toastService.toastSuccess("Biometria cadastrada com sucesso.");
            _this.contratoService
                .findByContrato(_this.activeRoute.snapshot.params.id)
                .subscribe(function (contrato) {
                _this.contrato = contrato;
                _this.situacaoDaBiometria();
            });
        }, function (error) {
            _this.snackBar.dismiss();
  ...
  @return void*/
    DetatalharContratosComponent.prototype.calcularValorPlanos = function () {
        var _this = this;
        this.contrato.planoContratado.forEach(function (data) {
            if (data.tipoContrato.toLocaleLowerCase().trim() === "plano") {
                _this.totalPLanoMensal += data.valorTotal;
            }
            else {
                _this.totalPlanoParticular += data.valorTotal;
            }
        });
    };
    DetatalharContratosComponent.prototype.situacaoDaBiometria = function () {
    ...
    DetatalharContratosComponent.prototype.editarPlano = function (event) {
  ...
  return void*/
    DetatalharContratosComponent.prototype.deletarPlano = function (event) {
        var _this = this;
        var configDialog = {
        ...
        this.dialogService
            ...
            if (accept) {
                _this.planoContratadoService
                    .deletePlanoContratado(event.id)
                    .subscribe(function (data) {
                    _this.planoContratadoService
                        .findAllPlanoContratado(_this.contrato.numero)
                        .subscribe(function (data) {
                        _this.data = [];
                        _this.data.push(data);
                        _this.contrato.planoContratado = data;
                        _this.totalPLanoMensal = 0;
                        _this.totalPlanoParticular = 0;
                        _this.calcularValorPlanos();
                        _this.toastService.toastSuccess("Serviço deletado com sucesso.");
                    });
                    _this.contratoService
                        .findByContrato(parseInt(_this.contrato.numero))
                        .subscribe(function (data) {
                        _this.contrato = data;
                    });
                }, function (error) {
  ...
  return void*/
    DetatalharContratosComponent.prototype.pegarDetalhesContrato = function () {
        var detalhesContrato = [];
    ...
    DetatalharContratosComponent.prototype.gerarDesconto = function () {
        var _this = this;
        var dialogConfig = {
            width: "700px",
            height: "250px",
        ...
        this.dialogService
            ...
            .afterClosed()
            .subscribe(function () {
            _this.findContratoService();
        });
    };
    DetatalharContratosComponent.ctorParameters = function () { return [
    ...
    return DetatalharContratosComponent;
}());
...
var DetatalharContratosModule = /** @class */ (function () {
    function DetatalharContratosModule() {
    }
    ...
    return DetatalharContratosModule;
}());
...
var TabelaServicosComponent = /** @class */ (function () {
    function TabelaServicosComponent() {
        this.columns = [];
        this.data = [];
    ...
    TabelaServicosComponent.prototype.ngOnInit = function () {
    };
    TabelaServicosComponent.prototype.clickEditar = function (event) {
        this.editar.emit(event);
    };
    TabelaServicosComponent.prototype.clickDeletar = function (event) {
    ...
    return TabelaServicosComponent;
}());
...
var TabelaServicosModule = /** @class */ (function () {
    function TabelaServicosModule() {
    }
...
var EditarPlanoContratadoComponent = /** @class */ (function () {
    function EditarPlanoContratadoComponent(behaviorPlanoContratado, activeRoute, router, toast, planoContratadoService) {
        var _this = this;
        this.behaviorPlanoContratado = behaviorPlanoContratado;
        this.activeRoute = activeRoute;
        this.router = router;
        ...
        this.activeRoute.params.subscribe(function (data) {
            _this.rota = '/contratos/' + data.id;
        });
    }
    EditarPlanoContratadoComponent.prototype.ngOnInit = function () {
        this.getInformacoesContratos();
        this.form();
    };
    EditarPlanoContratadoComponent.prototype.getInformacoesContratos = function () {
        var _this = this;
        this.subscription = this.behaviorPlanoContratado.getBehaviorView().subscribe(function (data) {
            if (data.servico != undefined) {
                _this.planoContratado = data;
            }
            else {
                _this.router.navigate([_this.rota]);
            }
        });
    };
    EditarPlanoContratadoComponent.prototype.mapHorarioEntradaOrSaida = function (data) {
        var hour = new String(data.hour);
        var minute = new String(data.minute);
        var horarios = ('0' + hour).slice(-2) + ':' + ('0' + minute).slice(-2);
        return horarios;
    };
    EditarPlanoContratadoComponent.prototype.mapDiaConsulta = function (diaConsulta) {
        var diasSemana = [];
        diaConsulta.forEach(function (dias) {
    ...
    EditarPlanoContratadoComponent.prototype.form = function () {
    ...
    EditarPlanoContratadoComponent.prototype.recuperarForm = function (event) {
        var _this = this;
        this.planoContratadoService.updatePlanoContratado(event).subscribe(function (data) {
            _this.router.navigate([_this.rota]);
            _this.toast.toastSuccess('Serviço contratado atualizado com sucesso.');
        }, function (error) {
            _this.toast.toastError(error.error.message);
        });
    };
    EditarPlanoContratadoComponent.prototype.ngOnDestroy = function () {
        this.subscription.unsubscribe();
    };
    EditarPlanoContratadoComponent.ctorParameters = function () { return [
    ...
    return EditarPlanoContratadoComponent;
}());
...
/* harmony import */ var _covalent_core_dialogs__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! @covalent/core/dialogs */ "./node_modules/@covalent/core/fesm5/covalent-core-dialogs.js");
...
var EditarPlanoContratadoModule = /** @class */ (function () {
    function EditarPlanoContratadoModule() {
    }
    ...
    return EditarPlanoContratadoModule;
}());
...
var FormCamposOcultosComponent = /** @class */ (function () {
    function FormCamposOcultosComponent() {
    }
    FormCamposOcultosComponent.prototype.ngOnInit = function () {
    };
    tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Input"])()
    ...
    return FormCamposOcultosComponent;
}());
...
var FormComponent = /** @class */ (function () {
    function FormComponent(formBuilder, activedRoute, behaviorInformacoesContrato, router, cd) {
        var _this = this;
    ...
    FormComponent.prototype.ngAfterViewChecked = function () {
   ...
   @return void*/
    FormComponent.prototype.formulario = function (planoContratado) {
    ...
    FormComponent.prototype.mapDiaConsulta = function (diaConsulta) {
        var _this = this;
        if (diaConsulta != null) {
            diaConsulta.forEach(function (data) {
                _this.checkBox.forEach(function (checkBox) {
   ...
   @return horarios String -  retorna o valor ja formatado*/
    FormComponent.prototype.mapHorarioSaidaOrEntrada = function (data) {
        var hour = new String(data.hour);
        var minute = new String(data.minute);
        var horarios = ("0" + hour).slice(-2) + ":" + ("0" + minute).slice(-2);
        return horarios;
    };
    FormComponent.prototype.calcularValorTotal = function () {
        var valorTotal = this.diasSemana.length * 4 * this.form.get("valorPlano").value * this.form.get("sessao").value;
        this.form.get("valorTotal").setValue(valorTotal);
    };
    FormComponent.prototype.valorSessao = function (event) {
        var _this = this;
        if (event) {
            this.services.forEach(function (data) {
                if (_this.form.get("servico").value === data.servico) {
                    _this.form.get("valorPlano").setValue(data.valor);
                }
            });
        }
    };
    ...
    @return void*/
    FormComponent.prototype.calcularNumerosSessao = function () {
        var minutosSessao = this.configParametros.tempoSessao['minute'];
        var horarioSaida = moment__WEBPACK_IMPORTED_MODULE_2__(this.form.get('horarioSaida').value, 'HH:mm').toObject();
        var horarioEntrada = moment__WEBPACK_IMPORTED_MODULE_2__(this.form.get('horarioEntrada').value, 'HH:mm').toObject();
        var parseMinutosHorarioSaida = this.parseMinutos(horarioSaida);
        var parseMinutosHorarioEntrada = this.parseMinutos(horarioEntrada);
        var sessao = (parseMinutosHorarioSaida - parseMinutosHorarioEntrada) / minutosSessao;
    ...
    FormComponent.prototype.parseMinutos = function (hora) {
    ...
    return void*/
    FormComponent.prototype.calcularTempoSessao = function (event) {
        if (event) {
            var sessao = this.form.get('sessao').value;
            var minutosSessao = sessao * this.configParametros.tempoSessao['minute'];
            var horaSaida = moment__WEBPACK_IMPORTED_MODULE_2__(this.form.get('horarioEntrada').value, 'HH:mm').add(minutosSessao, 'minutes').format('HH:mm');
   ...
   @return void*/
    FormComponent.prototype.getDetahesContrato = function () {
        var _this = this;
        this.subscription = this.behaviorInformacoesContrato
            .getBehaviorView()
            .subscribe(function (data) {
            if (data != null) {
                _this.detalhesContrato = data;
            }
            else {
                _this.router.navigate([_this.rota]);
            }
   ...
   @return void*/
    FormComponent.prototype.cancelar = function () {
        this.form.reset();
   ...
   return void*/
    FormComponent.prototype.changeCkeckBox = function (event) {
...
var NovoServicoComponent = /** @class */ (function () {
    function NovoServicoComponent(planoService, router, activedRoute, toast) {
    ...
    NovoServicoComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.activedRoute.params.subscribe(function (data) {
            _this.rota = '/contratos/' + data.id;
        });
    };
    NovoServicoComponent.prototype.recuperarForm = function (event) {
        var _this = this;
        var plano = event;
        this.planoService.savePlanoContratado(plano).subscribe(function (data) {
            _this.router.navigate(['/contratos/', event.numeroContrato]);
            _this.toast.toastSuccess('Serviço criado com sucesso. ');
        }, function (err) {
            _this.toast.toastError(err.error.message);
        });
    };
    NovoServicoComponent.ctorParameters = function () { return [
...
var NovoServicoModule = /** @class */ (function () {
    function NovoServicoModule() {
    }
...
var AlterarServicoComponent = /** @class */ (function () {
    function AlterarServicoComponent(_dialogService, inputValorDesconto, registro, formBuilder, registroService, servicoService, toastService) {
    ...
    AlterarServicoComponent.prototype.ngOnInit = function () {
        this.form();
        this.findAllServicos();
    };
    AlterarServicoComponent.prototype.ngAfterViewInit = function () {
        var _this = this;
        Object(rxjs__WEBPACK_IMPORTED_MODULE_7__["fromEvent"])(this.inputValorDesconto.nativeElement, 'keyup')
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_8__["filter"])(Boolean), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_8__["debounceTime"])(600), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_8__["distinctUntilChanged"])(), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_8__["tap"])(function (text) {
            _this.valorSessao = _this.formGroup.get('valorSessao').value;
        }))
            .subscribe();
    };
    AlterarServicoComponent.prototype.findAllServicos = function () {
        var _this = this;
        this.servicoService.findAll().subscribe(function (servico) {
            _this.servicos.push(servico);
        });
    };
    AlterarServicoComponent.prototype.form = function () {
    ...
    AlterarServicoComponent.prototype.alterarValorInput = function (event) {
        this.formGroup.get('valorSessao').setValue(event.value);
    };
    AlterarServicoComponent.prototype.trocarServico = function () {
        var _this = this;
        if (this.formGroup.valid) {
            var valorSessao = this.formGroup.get('valorSessao').value;
            this.registroService.trocaServico(this.registro.id, valorSessao)
                .subscribe(function (response) {
                _this.returnRegistro = response;
                _this.toastService.toastSuccess("Serviço alterado com sucesso.");
                _this._dialogService.closeAll();
            }, function (error) {
                _this.toastService.toastError(error.error.message);
            });
        }
    };
    AlterarServicoComponent.prototype.closeModal = function (event) {
        if (event) {
            this._dialogService.closeAll();
        }
    };
    AlterarServicoComponent.ctorParameters = function () { return [
    ...
    return AlterarServicoComponent;
}());
...
var RegistrarAusenciaProfissionalComponent = /** @class */ (function () {
    function RegistrarAusenciaProfissionalComponent(_dialogService, registroService, toastService, registro) {
        this._dialogService = _dialogService;
        this.registroService = registroService;
        this.toastService = toastService;
        this.registro = registro;
    }
    RegistrarAusenciaProfissionalComponent.prototype.ngOnInit = function () {
    };
    RegistrarAusenciaProfissionalComponent.prototype.confirmarTrocaDeProfissional = function () {
        var _this = this;
        this.registroService.ausenciaProfissional(this.registro.id).subscribe(function (registro) {
            _this.toastService.toastSuccess('Declarada ausência do profissional com sucesso.');
            _this._dialogService.closeAll();
        }, function (error) {
            _this.toastService.toastError(error.error.message);
            _this._dialogService.closeAll();
    ...
    RegistrarAusenciaProfissionalComponent.prototype.close = function () {
        this._dialogService.closeAll();
    };
    RegistrarAusenciaProfissionalComponent.ctorParameters = function () { return [
    ...
    return RegistrarAusenciaProfissionalComponent;
}());
...
var DECIMAL_FORMAT = function (v) { return new Intl.NumberFormat('pt-BR', { style: 'currency', currency: 'BRL' }).format(v); };
var DATA_FORMAT = function (v) {
    if (v != null) {
...
var SITUACAO_FORMAT = function (v) { return _shared_Enum_Situacao__WEBPACK_IMPORTED_MODULE_9__["Situacao"][v]; };
var RegistrosComponent = /** @class */ (function () {
    function RegistrosComponent(registroService, contratoService, activatedRoute, toastService, formBuilder, _dialogService, _viewContainerRef) {
        this.registroService = registroService;
        this.contratoService = contratoService;
    ...
    RegistrosComponent.prototype.startTable = function () {
        var _this = this;
        this.registroService.findAllRegistro(this.activatedRoute.snapshot.params.id, this.page, this.pageSize).subscribe(function (data) {
            _this.data = data['content'];
            _this.totalElements = data['totalElements'];
        });
    };
    RegistrosComponent.prototype.exportRegistros = function () {
        var _this = this;
        this.registroService.exportPlanilhaRegistros(this.activatedRoute.snapshot.params.id).subscribe(function (planilhaRegistro) {
            var date = new Date();
            var file = new Blob([planilhaRegistro], { type: 'application/vnd.openxmlformats-officedocument.spreadsheetml.sheet' });
            var fileURL = URL.createObjectURL(file);
            Object(file_saver__WEBPACK_IMPORTED_MODULE_10__["saveAs"])(fileURL, 'registros' + '_' + _this.numeroContrato + '_' +
                date.getDate() + '-'
    ...
    RegistrosComponent.prototype.findContratoById = function () {
        var _this = this;
        this.contratoService.findByContrato(this.activatedRoute.snapshot.params.id).subscribe(function (contrato) {
            _this.numeroContrato = contrato.numero;
        }, function (error) {
            _this.toastService.toastError(error.error.message);
        });
    };
    RegistrosComponent.prototype.changePageSize = function (event) {
        this.pageSize = event.pageSize;
        this.page = event.page - 1;
        this.startTable();
    };
    RegistrosComponent.prototype.form = function () {
        this.formGroup = this.formBuilder.group({
            beforeDate: [''],
            afterDate: ['']
        });
    };
    RegistrosComponent.prototype.resetDate = function () {
        this.startTable();
        this.formGroup.get('beforeDate').setValue('');
        this.formGroup.get('afterDate').setValue('');
    };
    RegistrosComponent.prototype.filterByData = function () {
        var _this = this;
        var dataInicial = this.formGroup.get('beforeDate').value;
        var dataFinal = this.formGroup.get('afterDate').value;
        var contratoId = this.activatedRoute.snapshot.params.id;
        this.registroService.findByDate(dataInicial, dataFinal, contratoId, this.page, this.pageSize).subscribe(function (registro) {
            _this.totalElements = registro['totalElements'];
            _this.data = registro['content'];
        }, function (error) {
            _this.toastService.toastError(error.error.message);
        });
    };
    RegistrosComponent.prototype.trocaServico = function (trocaServico) {
        this.openTrocaServico(trocaServico);
    };
    RegistrosComponent.prototype.openTrocaServico = function (tableRow) {
        var _this = this;
        var dialogConfig = {
            width: '650px',
            height: '250px',
        ...
        if (tableRow) {
            this._dialogService.open(_alterar_servico_alterar_servico_component__WEBPACK_IMPORTED_MODULE_8__["AlterarServicoComponent"], dialogConfig).afterClosed().subscribe(function () {
                _this.startTable();
            });
        }
    };
    RegistrosComponent.prototype.trocaProfissional = function (trocaProfissional) {
        this.confirmTrocaDeProfissional(trocaProfissional);
    };
    RegistrosComponent.prototype.confirmTrocaDeProfissional = function (tableRow) {
        this.gerarDesconto(tableRow);
    };
    RegistrosComponent.prototype.gerarDesconto = function (registro) {
        var _this = this;
        var dialogConfig = {
            width: "650px",
            height: "250px",
        ...
        this._dialogService.open(_registrar_ausencia_profissional_registrar_ausencia_profissional_component__WEBPACK_IMPORTED_MODULE_11__["RegistrarAusenciaProfissionalComponent"], dialogConfig).afterClosed().subscribe(function () {
            _this.startTable();
        });
    };
...
var FilterComponent = /** @class */ (function () {
    function FilterComponent(iconRegistry, sanitizer) {
        this.placeholder = '';
    ...
    FilterComponent.prototype.filterByNumeroContrato = function ($event) {
...
var GerarDescontoComponent = /** @class */ (function () {
    function GerarDescontoComponent(dialogService, contrato, inputValorSessao, formBuilder, contratoService, message) {
        this.dialogService = dialogService;
    ...
    GerarDescontoComponent.prototype.ngOnInit = function () {
        this.form();
    };
    GerarDescontoComponent.prototype.ngAfterViewInit = function () {
        var _this = this;
        Object(rxjs__WEBPACK_IMPORTED_MODULE_7__["fromEvent"])(this.inputValorSessao.nativeElement, 'keyup')
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_8__["filter"])(Boolean), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_8__["debounceTime"])(600), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_8__["distinctUntilChanged"])(), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_8__["tap"])(function (text) {
            _this.valorDesconto = _this.formGroup.get('valorDesconto').value;
        }))
            .subscribe();
    };
    GerarDescontoComponent.prototype.form = function () {
        this.formGroup = this.formBuilder.group({
            valorDesconto: ['']
        });
    };
    GerarDescontoComponent.prototype.calculoValorContratoAposDesconto = function () {
        return this.contrato.valorTotal - this.valorDesconto;
    };
    GerarDescontoComponent.prototype.gerarDesconto = function () {
        var _this = this;
        this.contratoService.gerarDesconto(this.contrato.numero, this.valorDesconto).subscribe(function (contrato) {
            _this.returnContrato = contrato;
            _this.message.toastSuccess('Desconto gerado com sucesso.');
            _this.dialogService.closeAll();
        }, function (error) {
            _this.message.toastError(error.error.message);
        });
    };
    GerarDescontoComponent.prototype.closeModal = function (event) {
        this.dialogService.closeAll();
    };
    GerarDescontoComponent.ctorParameters = function () { return [
...
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _covalent_core_loading__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @covalent/core/loading */ "./node_modules/@covalent/core/fesm5/covalent-core-loading.js");
/* harmony import */ var _shared_Services_contrato_service__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./../../../../shared/Services/contrato.service */ "./src/app/shared/Services/contrato.service.ts");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
...
var ImportComponent = /** @class */ (function () {
    function ImportComponent(_dialogService, contratoService, toast, loading, behaviorSubject, behaviorRefreshTableContrato) {
        this._dialogService = _dialogService;
        this.contratoService = contratoService;
        this.toast = toast;
    ...
    ImportComponent.prototype.selectEvent = function (files) {
    ...
    ImportComponent.prototype.import = function () {
        ...
        this.contratoService.importContratos(this.formData).subscribe(function (res) {
            _this.loading.resolve('spinnerProgress');
            _this.messageFeedBackOpen = true;
            _this.isSuccess = true;
            _this.behaviorSubject.setBehaviorView(res);
            _this.behaviorRefreshTableContrato.setBehaviorView(true);
        }, function (error) {
            _this.toast.toastError(error.error.message);
            _this.loading.resolve('spinnerProgress');
        });
    };
    ImportComponent.prototype.buttonFechar = function ($event) {
        this._dialogService.closeAll();
    };
...
var ImportButtonComponent = /** @class */ (function () {
    function ImportButtonComponent() {
        this.click = new _angular_core__WEBPACK_IMPORTED_MODULE_1__["EventEmitter"]();
    }
    ImportButtonComponent.prototype.ngOnInit = function () { };
    ImportButtonComponent.prototype.clickImport = function ($event) {
...
var ImportFeedBackComponent = /** @class */ (function () {
    function ImportFeedBackComponent(behaviorFeedBack) {
        this.behaviorFeedBack = behaviorFeedBack;
        this.message = '';
    }
    ImportFeedBackComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.subscription = this.behaviorFeedBack.getBehaviorView().subscribe(function (message) { return _this.message = ' Foram salvos: '
            + message.save + ' Contratos' + ' e ' +
            'Foram atualizados: ' + message.update + ' Contratos'; });
    };
    ImportFeedBackComponent.prototype.ngOnDestroy = function () {
        this.subscription.unsubscribe();
    };
    ImportFeedBackComponent.ctorParameters = function () { return [
    ...
    return ImportFeedBackComponent;
}());
...
var INT_FORMAT = function (v) { return parseInt(v); };
var VisualizarContratosComponent = /** @class */ (function () {
    function VisualizarContratosComponent(_dialogService, contratoService, configParametrosService, activeRoute, behaviorRefreshTableContrato, route, planoContratadoService) {
        this._dialogService = _dialogService;
        this.contratoService = contratoService;
    ...
    VisualizarContratosComponent.prototype.ngOnInit = function () {
        this.startTable();
    ...
    VisualizarContratosComponent.prototype.findServiceAndPlanoContratado = function () {
        var _this = this;
        this.configParametrosService
            .findCofigParametros("1")
            .subscribe(function (config) {
            _this.configParametro = config;
        });
        this.planoContratadoService.hoursByService().subscribe(function (data) {
            _this.hoursByService = data;
        });
    };
    VisualizarContratosComponent.prototype.calcularSaldoTotal = function () {
        var _this = this;
        var date = new Date();
        this.contratoService
            .getRelatorios(0, 2147483647, date.getFullYear(), date.getMonth() + 1)
            .subscribe(function (relatorio) {
            var array = [];
            array = relatorio['pageList'];
            array.forEach(function (relatorio) {
                _this.saldoTotal += parseInt(relatorio.valorExecutado.toString());
            });
        });
    };
  ...
  @return void*/
    VisualizarContratosComponent.prototype.startTable = function () {
  ...
  @return void*/
    VisualizarContratosComponent.prototype.findByFilter = function () {
        var _this = this;
        this.contratoService
            .findByFilters(this.nomePaciente, this.numero, this.page, this.pageSize, this.statusContrato, "ASC", "numero")
            .subscribe(function (pageFilter) {
            _this.total = pageFilter.totalElements;
            _this.contratos = pageFilter["content"];
        });
    };
  ...
  @return void*/
    VisualizarContratosComponent.prototype.filterContratoStatusContrato = function (event) {
  ...
  pagesize e page
  @void*/
    VisualizarContratosComponent.prototype.changePageSize = function (event) {
        this.pageSize = event.pageSize;
        this.page = event.page - 1;
        this.findByFilter();
    };
  ...
  @void*/
    VisualizarContratosComponent.prototype.filterContrato = function (event) {
        this.numero = event;
        this.findByFilter();
    };
  ...
  @param event - evento aonde recebe o texto digitado , aonde e disparado a requesicao apos um delay pre determinado
  @void*/
    VisualizarContratosComponent.prototype.filterNomePaciente = function (event) {
  ...
  @return void*/
    VisualizarContratosComponent.prototype.sort = function (sortEvent) {
        var _this = this;
  ...
  @return void*/
    VisualizarContratosComponent.prototype.refreshTableContratoAfterImport = function () {
        var _this = this;
        this.subscription = this.behaviorRefreshTableContrato
            ...
            if (data === true) {
                _this.contratoService
                    ...
                    _this.page = data.totalElements;
                    _this.contratos = data["content"];
                });
                _this.planoContratadoService
                    .findTotalActiveContracts()
                    .subscribe(function (data) {
                    _this.valorTotalContratosAtivos = data;
                });
            }
        });
    };
  ...
  @void*/
    VisualizarContratosComponent.prototype.openModalImport = function ($event) {
  ...
  @return void*/
    VisualizarContratosComponent.prototype.rowClick = function (event) {
        this.numeroContrato = event.row.numero;
        this.route.navigate(["contratos/" + this.numeroContrato]);
    };
    VisualizarContratosComponent.prototype.ngOnDestroy = function () {
        this.subscription.unsubscribe();
    };
    VisualizarContratosComponent.ctorParameters = function () { return [
        { type: _covalent_core_dialogs__WEBPACK_IMPORTED_MODULE_5__["TdDialogService"] },
        { type: _shared_Services_contrato_service__WEBPACK_IMPORTED_MODULE_2__["ContratoService"] },
    ...
    return VisualizarContratosComponent;
}());
...
var TimePipePipe = /** @class */ (function () {
    function TimePipePipe() {
    }
    TimePipePipe.prototype.transform = function (value) {
...
var PipeTimeModule = /** @class */ (function () {
    function PipeTimeModule() {
    }
...
var BehaviorInformacoesContratoService = /** @class */ (function () {
    function BehaviorInformacoesContratoService() {
        this.behave = new rxjs__WEBPACK_IMPORTED_MODULE_2__["BehaviorSubject"](null);
    }
    BehaviorInformacoesContratoService.prototype.setBehaviorView = function (behave) {
        this.behave.next(behave);
    };
    BehaviorInformacoesContratoService.prototype.getBehaviorView = function () {
    ...
    return BehaviorInformacoesContratoService;
}());
...
var BehaviorMessageFeedBackService = /** @class */ (function () {
    function BehaviorMessageFeedBackService() {
    ...
    BehaviorMessageFeedBackService.prototype.setBehaviorView = function (behave) {
        this.behave.next(behave);
    };
    BehaviorMessageFeedBackService.prototype.getBehaviorView = function () {
        return this.behave.asObservable();
    };
    ...
    return BehaviorMessageFeedBackService;
}());
...
var BehaviorPlanoContratadoService = /** @class */ (function () {
    function BehaviorPlanoContratadoService() {
    ...
    BehaviorPlanoContratadoService.prototype.setBehaviorView = function (behave) {
        this.behave.next(behave);
    };
    BehaviorPlanoContratadoService.prototype.getBehaviorView = function () {
        return this.behave.asObservable();
    };
    ...
    return BehaviorPlanoContratadoService;
}());
...
var BehaviorSubjectContratoRefreshService = /** @class */ (function () {
    function BehaviorSubjectContratoRefreshService() {
        this.behave = new rxjs__WEBPACK_IMPORTED_MODULE_2__["BehaviorSubject"](false);
    }
    BehaviorSubjectContratoRefreshService.prototype.setBehaviorView = function (behave) {
        this.behave.next(behave);
    };
    BehaviorSubjectContratoRefreshService.prototype.getBehaviorView = function () {
        return this.behave.asObservable();
    };
    ...
    return BehaviorSubjectContratoRefreshService;
}());
...
var ConfigParametrosService = /** @class */ (function () {
    function ConfigParametrosService(http) {
        this.http = http;
    }
    ConfigParametrosService.prototype.findCofigParametros = function (configId) {
        return this.http.get(API_URL + '/config-parametros/' + configId);
    };
    ConfigParametrosService.ctorParameters = function () { return [
    ...
    return ConfigParametrosService;
}());
...
var API_URL = 'http://209.172.51.58:24889/ProjetoX-0.0.1-SNAPSHOT/v1';
var PlanoContratadoService = /** @class */ (function () {
    function PlanoContratadoService(httpClient) {
        this.httpClient = httpClient;
    }
    // Handle API errors
    PlanoContratadoService.prototype.handleError = function (error) {
    ...
    ;
    PlanoContratadoService.prototype.findTotalActiveContracts = function () {
        return this.httpClient.get(API_URL + '/planos/valor-total').pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["map"])(function (data) { return data; }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["catchError"])(this.handleError));
    };
    PlanoContratadoService.prototype.savePlanoContratado = function (planoContratado) {
        return this.httpClient.post(API_URL + '/planos', planoContratado);
    };
    PlanoContratadoService.prototype.findPlanoContratados = function (numeroContrato, servico, tipoContrato) {
    ...
    PlanoContratadoService.prototype.updatePlanoContratado = function (planoContratado) {
        return this.httpClient.put(API_URL + '/planos', planoContratado);
    };
    PlanoContratadoService.prototype.findAllPlanoContratado = function (numeroContrato) {
        return this.httpClient.get(API_URL + '/planos/find-all?numero-contrato=' + numeroContrato);
    };
    PlanoContratadoService.prototype.hoursByService = function () {
        return this.httpClient.get(API_URL + '/planos/hours-by-service');
    };
    PlanoContratadoService.prototype.deletePlanoContratado = function (planoContratadoId) {
        return this.httpClient.put(API_URL + '/planos/delete', planoContratadoId);
    };
    PlanoContratadoService.ctorParameters = function () { return [
...
var ServicesService = /** @class */ (function () {
    ...
    ServicesService.prototype.findAll = function () {
        return this.http.get(API_URL + '/servicos').pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_1__["map"])(function (data) { return data; }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_1__["catchError"])(this.handleError));
    };
...
var ConfigParametro = /** @class */ (function () {
    function ConfigParametro() {
    }
...
var FormPlanoContratado = /** @class */ (function () {
    function FormPlanoContratado() {
    }
    return FormPlanoContratado;
}());
...
var PlanoContratado = /** @class */ (function () {
    function PlanoContratado() {
    }
...
var ConfigParametrosResolve = /** @class */ (function () {
    function ConfigParametrosResolve(configParametrosService) {
        this.configParametrosService = configParametrosService;
    }
    ConfigParametrosResolve.prototype.resolve = function (route, state) {
        return this.configParametrosService.findCofigParametros('1');
    };
    ConfigParametrosResolve.ctorParameters = function () { return [
    ...
    return ConfigParametrosResolve;
}());
...
var ContratoResolveFindByNumeroResolve = /** @class */ (function () {
    function ContratoResolveFindByNumeroResolve(contratoService) {
        this.contratoService = contratoService;
    }
    ContratoResolveFindByNumeroResolve.prototype.resolve = function (route, state) {
        return this.contratoService.findByContrato(route.params.id);
    };
    ContratoResolveFindByNumeroResolve.ctorParameters = function () { return [
    ...
    return ContratoResolveFindByNumeroResolve;
}());
...
var ContratoResolverResolve = /** @class */ (function () {
    function ContratoResolverResolve(contratoService) {
        this.contratoService = contratoService;
    }
    ContratoResolverResolve.prototype.resolve = function (route, state) {
        return this.contratoService.findAllContratos(0, 10, 'ASC', 'numero');
    };
    ContratoResolverResolve.ctorParameters = function () { return [
        { type: _Services_contrato_service__WEBPACK_IMPORTED_MODULE_1__["ContratoService"] }
    ]; };
    ...
    return ContratoResolverResolve;
}());
...
var findActiveContractNumberResolve = /** @class */ (function () {
    function findActiveContractNumberResolve(planoContratadoService) {
        this.planoContratadoService = planoContratadoService;
    }
    findActiveContractNumberResolve.prototype.resolve = function (route, state) {
        return this.planoContratadoService.findTotalActiveContracts();
    };
    findActiveContractNumberResolve.ctorParameters = function () { return [
    ...
    return findActiveContractNumberResolve;
}());
...
var FindAllPlanoContratadoResolve = /** @class */ (function () {
    function FindAllPlanoContratadoResolve(planoContratadoService) {
        this.planoContratadoService = planoContratadoService;
    }
    FindAllPlanoContratadoResolve.prototype.resolve = function (route, state) {
        return this.planoContratadoService.findAllPlanoContratado(route.params.id);
    };
    FindAllPlanoContratadoResolve.ctorParameters = function () { return [
    ...
    return FindAllPlanoContratadoResolve;
}());
...
var FindAllResolve = /** @class */ (function () {
    function FindAllResolve(seervicosService) {
        this.seervicosService = seervicosService;
    }
    FindAllResolve.prototype.resolve = function (route, state) {
        return this.seervicosService.findAll();
    };
    FindAllResolve.ctorParameters = function () { return [
...
//# sourceMappingURL=app-Modulos-contratos-contratos-module-es5.js.map