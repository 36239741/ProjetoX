...
public class ContratoServiceTest extends AbstractIntegrationTests {
...
/* Teste que para verifica a consulta do relatorio mensal de um contrato com 0 registros*/
	...
	@Sql({ "/dataset/contrato/truncate.sql", "/dataset/account/users.sql", "/dataset/contrato/Servico.sql", "/dataset/contrato/Contrato.sql",
		"/dataset/contrato/PlanoContratado.sql","/dataset/contrato/RegistroTestExportPlanilha.sql","/dataset/Config.sql" })
	@Test
